...
```{r basic_coverage_joint_plot, echo=FALSE, fig.height = 4, fig.width = 12, fig.align = "center"}
...
```{r basic_coverage_3_plot, echo=FALSE, fig.height = 6, fig.width = 12, fig.align = "center"}
knitr::include_graphics("../man/figures/README-basic_coverage_3-1.png")
```
...
```{r transcript_coverage_tight, eval=FALSE}
basic.coverage +
  geom_transcript(gtf.gr=gtf.gr, overlap.style = "tight", label.vjust = 1.5)
```

```{r transcript_coverage_tight_plot, echo=FALSE, fig.height = 12, fig.width = 12, fig.align = "center"}
knitr::include_graphics("../man/figures/README-transcript_coverage_tight-1.png")
```
...
#### Basic coverage
```{r cnv_basic_coverage_dna, eval=FALSE}
basic.coverage = ggcoverage(data = track.df, color = "grey",
                            mark.region = NULL, range.position = "out")
basic.coverage
```

```{r cnv_basic_coverage_dna_plot, echo=FALSE, fig.height = 6, fig.width = 12, fig.align = "center"}
knitr::include_graphics("../man/figures/README-cnv_basic_coverage_dna-1.png")
```
...
## Basic coverage
```{r basic_coverage_hic, eval=FALSE}
basic.coverage = ggcoverage(data = track.df, color = "grey",
                            mark.region = NULL, range.position = "out")
basic.coverage
```

```{r basic_coverage_hic_plot, echo=FALSE, fig.height = 6, fig.width = 12, fig.align = "center"}
knitr::include_graphics("../man/figures/README-basic_coverage_hic-1.png")
```
...
```{r basic_coverage_protein_feature_plot, echo=FALSE, fig.height = 8, fig.width = 12, fig.align = "center"}
